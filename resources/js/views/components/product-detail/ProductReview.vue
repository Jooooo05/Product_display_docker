...
const comments = shallowRef<commentsType[]>([
    {
        ...
        avatar: "/assets/images/placeholder_image.jpg",
...
<template>
    <v-row>
                    ...
                    <v-col cols="12" md="7" sm="4" class="pa-sm-4">
                        <div class="pt-sm-0 pt-5">
                            <h2 class="text-h2 mb-2 d-flex align-center">
                                4
                                <h4 class="text-h4 text-lightText mb-0 ms-1">
                                    /5
                                </h4>
                            </h2>
                            ...
                            <div
                                class="text-medium-emphasis align-center d-flex ga-2"
                            >
                                <v-rating
                                    color="inputBorder"
                    ...
                    <v-col cols="12" md="5" sm="8" class="pa-sm-4">
                        <div class="pa-sm-4">
                            <div class="d-flex align-center ga-4 my-2">
                                ...
                                ></v-progress-linear>
                                <div
                                    class="text-no-wrap text-caption text-lightText"
                                >
                                    5 Stars
                                </div>
                            </div>
        ...
        <v-col lg="12">
            <v-card
                variant="flat"
                class="d-flex align-center mb-7 bg-containerBg"
                rounded="lg"
    ...
    <div class="text-center mb-6">
        <v-btn variant="text" rounded="md" color="primary"
    ...
    <div class="position-relative">
        ...
        ></v-textarea>
        <div
            class="comment-panel d-flex justify-space-between align-center pa-3"
        >
            <div>
                <v-btn
                    icon
            ...
            <v-btn color="primary" rounded="md" variant="flat" size="small"
                >Comment</v-btn
            >
        </div>
    </div>
